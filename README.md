## 导语：
```
世界上有些东西，你可以看不到，也摸不着，但不能否定其存在。
当想你想下载苹果的一个操作系统时，当你想看一篇关于叙利亚的文章时，当你想用google搜索“温”时候，
你发现你打不开网站，不是因为网站服务器出了问题，而是你硬生生地撞到了墙上，这堵墙也就是“GFW”。
身处的”互联网”的我们，也不过是一堵墙内上个局域网罢了。
```
## 翻墙梯子
```
